...
> Relocated from dome_nav → dome_mission (2026-07-31, F35 T06). See F02 banner.
> Historical record; the live logic is now dome_mission's `label_resolver` +
> `mission_node` (TF35 T05).
